...
function create_provider_store() {
    /**
     * WC Provider Product Data Store: Stored in CPT.
     *
     * @version  0.1
     * @category Class
     * @author   MYC
     */
    class WC_Product_Provider_Data_Store_CPT extends WC_Product_Data_Store_CPT implements WC_Object_Data_Store_Interface {

	/**
	 * Helper method that updates all the post meta for an provider.
	 *
	 * @param WC_Product_Provider
...
add_action( 'plugins_loaded', 'create_provider_store' );
